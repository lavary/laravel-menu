 ...
 * Class Item
 *
 * This class manages menu items.  Much of the functionality of the Builder
 * class is duplicated here, but this class provides that functionality for
 * a menu item not a menu as a whole.
 *
 * For example Builder::add() provides the functionality to add a top level
 * item to a menu, but Item::add() adds a sub-item to an existing menu item.
 *
 * @see  Builder
 */
class Item
