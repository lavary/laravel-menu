...
* [Referring to Items](https://github.com/lavary/laravel-menu#referring-to-items)
	- [Get Item by Title](https://github.com/lavary/laravel-menu#get-item-by-title)
	- [Get Item by Id](https://github.com/lavary/laravel-menu#get-item-by-id)
	- [Get All Items](https://github.com/lavary/laravel-menu#get-all-items)
	- [Get the First Item](https://github.com/lavary/laravel-menu#get-the-first-item)
	- [Get the Last Item](https://github.com/lavary/laravel-menu#get-the-last-item)
	- [Get Sub-items of the Item](https://github.com/lavary/laravel-menu#get-sub-items-of-the-item)
	- [Magic Where Methods](https://github.com/lavary/laravel-menu#magic-where-methods)
...
* [Active Item](https://github.com/lavary/laravel-menu#active-item)
	- [RESTful URLs](https://github.com/lavary/laravel-menu#restful-urls)
	- [URL Wildcards](https://github.com/lavary/laravel-menu#url-wildcards)
...
* [Rendering Methods](https://github.com/lavary/laravel-menu#rendering-methods)
	- [Menu as Unordered List](https://github.com/lavary/laravel-menu#menu-as-unordered-list)
	- [Menu as Ordered List](https://github.com/lavary/laravel-menu#menu-as-ordered-list)
	- [Menu as Div](https://github.com/lavary/laravel-menu#menu-as-div)
	- [Menu as Bootstrap 3 Navbar](https://github.com/lavary/laravel-menu#menu-as-bootstrap-3-navbar)
